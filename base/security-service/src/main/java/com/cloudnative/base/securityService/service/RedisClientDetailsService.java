package com.cloudnative.base.securityService.service;

import com.alibaba.fastjson.JSONObject;
import com.cloudnative.base.support.auth.details.DefaultClientDetails;
...
public class RedisClientDetailsService extends JdbcClientDetailsService {
	...
	private static class ClientDetailsRowMapper implements RowMapper<ClientDetails> {
		private com.cloudnative.base.securityService.json.JsonMapper mapper = createJsonMapper();
	 ...
	 * @return
	 */
	private static com.cloudnative.base.securityService.json.JsonMapper createJsonMapper() {
		if (ClassUtils.isPresent("org.codehaus.jackson.map.ObjectMapper", null)) {
			return new com.cloudnative.base.securityService.json.JacksonMapper();
		}
		else if (ClassUtils.isPresent("com.fasterxml.jackson.databind.ObjectMapper", null)) {
			return new com.cloudnative.base.securityService.json.Jackson2Mapper();
		}
		return new com.cloudnative.base.securityService.json.NotSupportedJsonMapper();
	}
